...
2. Download & install [NPM](https://www.npmjs.com/).
3. Use NPM to download [Express](https://www.npmjs.com/package/express)
4. Clone this repository: `git clone https://github.com/Ransomwave/Roblox-Stream-Donations`
5. Edit `server.js` & Replace the default `CLIENT_SECRET`.
6. Customize the HTML code (the `index.html` file) as much as you want. (Change the style, text, gif, music... Anything!)
7. Publish your web server to a host (free ones include Vercel or Netlify).
8. On Roblox, use the .rblx place file linked below _(THERE WILL BE A TEMPLATE SOON)_ or create your own. (Be sure the HTTP requests are pointing to /api/donnations _(eg. https://donos-example.vercel.io/api/donations)_)
9. Once you're happy with how your donations look, create a repository on GitHub and upload your code.
10. Sign up to a free host like [Vercel](https://vercel.com)
11. Make a new Project & associate it with your new repository.
12. Once It's uploaded, copy the generated URL (ex. https://donos-example.vercel.io/)
13. Add the link as a Browser Source to OBS
